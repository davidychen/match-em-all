...
const cardHeaderStyle = {
  cardHeader: {
    ...
    zIndex: "3 !important",
    "&$cardHeaderPlain,&$cardHeaderImage,&$cardHeaderContact,&$cardHeaderSignup,&$cardHeaderIcon,&$cardHeaderStats,&$warningCardHeader,&$successCardHeader,&$dangerCardHeader,&$infoCardHeader,&$primaryCardHeader,&$roseCardHeader,&$whiteCardHeader": {
      margin: "0 15px",
      padding: "0",
      position: "relative",
      color: whiteColor
